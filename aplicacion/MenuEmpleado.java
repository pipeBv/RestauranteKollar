    ...
    private JPanel crearPanelPedidos() {
        ...
        btnHacerPedido.addActionListener(e -> {
            ...
            if (platoSeleccionado != null) {
                ...
                // CAMBIO AQUÍ: Guardamos el resultado (true o false)
                boolean compraExitosa = hacerPedido.realizarPedido(platoSeleccionado, cantidad);

                // SOLO si la compra fue exitosa (true), actualizamos el texto de abajo
                if (compraExitosa) {
                    cargarDatos();
                    this.presupuesto = presupuestoManager.cargarPresupuesto();
                    ...
                    // Si falló (false), no tocamos el área de texto o mostramos error
